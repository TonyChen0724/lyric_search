...
class Lyrics extends Component {
    ...
    componentDidMount() {
        ...
        .then(res=> {
            ...
            return axios.get(`https://cors-anywhere.herokuapp.com/http://api.musixmatch.com/ws/1.1/track.get?track_id=${this.props.match.params.id}&apikey=c0633d5aaa2b27ace7481b0dbf3da53b`);
        })
        .then(res => {
